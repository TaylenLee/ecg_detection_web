...
from apps.users.forms import RegisterForm, LoginForm, ChangePasswordForm
        ...
        if form.validate():
            ...
            try:
                ...
                if not user.password.check_password(password):
                    ...
                    # re_data["token"] = token
                    # re_data["token"] = jwt.decode(token, self.settings["secret_key"], algorithms='HS256')
...
class CheckLoginHandler(RedisHandler):
    @authenticated_async
